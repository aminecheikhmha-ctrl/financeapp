    ...
    try {
      ...
      if (authError) {
        ...
        if (msg.includes("invalid login") || msg.includes("invalid credentials")) {
          ...
          setError("Merci de confirmer ton email avant de te connecter.")
        } else {
      ...
      // Check onboarding status — gracefully handle missing profile
      ...
      try {
        ...
        // Profile fetch failed — default to onboarding
      }
        ...
        <div className="space-y-4">
          ...
          <div>
            <div className="flex items-center justify-between mb-1.5">
              ...
              <button onClick={() => setShowReset(true)} className="text-xs text-gray-600 hover:text-green-400 transition">
                Mot de passe oublié ?
              </button>
            </div>
            <input
            ...
            <div className="bg-[#111] border border-white/10 rounded-2xl p-6 w-full max-w-sm" onClick={e => e.stopPropagation()}>
              ...
              {resetSent ? (
                ...
                <>
                  ...
                  <button onClick={() => setShowReset(false)} className="w-full mt-2 text-gray-600 text-xs hover:text-gray-400 transition py-1">
                    Annuler
                  </button>
                </>
              )}
