    ...
    return (
      <div className="min-h-screen bg-[#080808] flex items-center justify-center px-6">
        <div className="bg-[#111] border border-white/10 rounded-2xl p-8 w-full max-w-md text-center">
          ...
          <a href="/login" className="inline-block mt-6 px-6 py-3 rounded-xl bg-green-500 hover:bg-green-400 text-black font-black text-sm transition">Se connecter →</a>
        </div>
      </div>
    )
  }
    ...
    <div className="min-h-screen bg-[#080808] flex">
      ...
      <div className="flex-1 flex flex-col justify-center px-8 py-12 max-w-md mx-auto lg:mx-0 lg:px-16 w-full">
        ...
        <div className="grid grid-cols-2 gap-3 mb-5">
          ...
          <button onClick={handleAppleSignup} disabled={loadingApple}
            className="flex items-center justify-center gap-2 bg-white/5 hover:bg-white/8 disabled:opacity-50 border border-white/10 text-white py-3 rounded-xl font-semibold transition text-sm">
        ...
        <p className="text-gray-600 text-sm text-center mt-6">
          Déjà un compte ?{" "}
          <a href="/login" className="text-green-400 hover:text-green-300 font-semibold">Se connecter</a>
        </p>
      </div>
